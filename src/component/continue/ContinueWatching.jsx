...
import AdBetweenImages from "@/component/AdBetweenImages/AdBetweenImages";
...
const ContinueWatching = (props) => {
  ...
  const slidesWithAd = [...memoizedWatchList];

  if (slidesWithAd.length > 1) {
    slidesWithAd.splice(1, 0, { isAd: true });
  }
